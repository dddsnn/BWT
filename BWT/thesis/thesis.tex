...
\begin{tabular}{ccccc}
\rot{Metric} & \rot{weighted} & \rot{entropy length prediction} & \rot{MTF
prediction} & \rot{out size all columns} \\ \hline
\multirow{30}{*}{Badness} & \ding{55} & \ding{55} &
\multicolumn{1}{c|}{\ding{55}} & 2139673 \\ \cline{2-5}
& \ding{55} & \ding{55} & \multicolumn{1}{c|}{generic mean} & 2138203 \\
\cline{2-5}
& \ding{55} & \ding{55} & \multicolumn{1}{c|}{generic median} & 2142013 \\
\cline{2-5}
& \ding{55} & \ding{55} & \multicolumn{1}{c|}{specific mean} & 2134390 \\
\cline{2-5}
& \ding{55} & \ding{55} & \multicolumn{1}{c|}{specific median} & 2138527 \\
\cline{2-5}
& \ding{55} & complete & \multicolumn{1}{c|}{\ding{55}} & 2139013 \\ \cline{2-5}
& \ding{55} & complete & \multicolumn{1}{c|}{generic mean} & 2133935 \\
\cline{2-5}
& \ding{55} & complete & \multicolumn{1}{c|}{generic median} &
2135820 \\ \cline{2-5}
& \ding{55} & complete & \multicolumn{1}{c|}{specific
mean} & 2135364 \\ \cline{2-5}
& \ding{55} & complete & \multicolumn{1}{c|}{specific median} & 2140979 \\
\cline{2-5}
& \ding{55} & sparse & \multicolumn{1}{c|}{\ding{55}} & 2139013 \\
\cline{2-5}
& \ding{55} & sparse & \multicolumn{1}{c|}{generic mean} & 2133644 \\
\cline{2-5}
& \ding{55} & sparse & \multicolumn{1}{c|}{generic median} & 2135622 \\
\cline{2-5}
& \ding{55} & sparse & \multicolumn{1}{c|}{specific mean} & 2136052 \\
\cline{2-5}
& \ding{55} & sparse & \multicolumn{1}{c|}{specific median} &
2138426 \\ \cline{2-5}
& \ding{51} & \ding{55} & \multicolumn{1}{c|}{\ding{55}}
& 2135080 \\ \cline{2-5}
& \ding{51} & \ding{55} & \multicolumn{1}{c|}{generic mean} & 2133012 \\
\cline{2-5}
& \ding{51} & \ding{55} & \multicolumn{1}{c|}{generic median} &
2134234 \\ \cline{2-5}
& \ding{51} & \ding{55} & \multicolumn{1}{c|}{specific mean} & 2132082 \\
\cline{2-5} & \ding{51} & \ding{55} & \multicolumn{1}{c|}{specific median} &
2140333 \\ \cline{2-5}
& \ding{51} & complete & \multicolumn{1}{c|}{\ding{55}} & 2136412 \\ \cline{2-5}
& \ding{51} & complete & \multicolumn{1}{c|}{generic mean} & 2134734 \\
\cline{2-5}
& \ding{51} & complete & \multicolumn{1}{c|}{generic median} &
2134390 \\ \cline{2-5}
& \ding{51} & complete & \multicolumn{1}{c|}{specific
mean} & 2134469 \\ \cline{2-5}
& \ding{51} & complete & \multicolumn{1}{c|}{specific median} & 2136416 \\
\cline{2-5}
& \ding{51} & sparse & \multicolumn{1}{c|}{\ding{55}} & 2136417 \\ \cline{2-5}
& \ding{51} & sparse & \multicolumn{1}{c|}{generic mean} & 2135061 \\
\cline{2-5}
& \ding{51} & sparse & \multicolumn{1}{c|}{generic median} & 2134390 \\
\cline{2-5}
& \ding{51} & sparse & \multicolumn{1}{c|}{specific mean} & 2135461 \\
\cline{2-5}
& \ding{51} & sparse & \multicolumn{1}{c|}{specific median} &
2134783 \\ \hline
